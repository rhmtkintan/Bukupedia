<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="<?= base_url("Admin/Anggota") ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-user-circle"></i>
                <div data-i18n="Layouts">Anggota</div>
            </a>
        </li>
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Approval</span>
        </li>
        <li class="menu-item">
            <a href="<?= base_url("Admin/checklist") ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-check"></i>
                <div data-i18n="Layouts">Ajuan Pinjaman</div>
            </a>
        </li>
        </li>
        <li class="menu-header small text-uppercase">
        ...
        <li class="menu-item">
            <a href="<?= base_url("Admin/Pinjaman") ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-credit-card"></i>
                <div data-i18n="Layouts">Pinjaman</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="<?= base_url("Admin/Simpanan") ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-wallet"></i>
                <div data-i18n="Layouts">Simpanan</div>
            </a>
        </li>
        <li class="menu-header small text-uppercase">
        ...
        <li class="menu-item">
            <a href="<?= base_url("Admin/ditolak") ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-x"></i>
                <div data-i18n="Layouts">Pinjaman Ditolak</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="" class="menu-link" data-bs-toggle="modal" data-bs-target="#exampleModal">
                <i class="menu-icon tf-icons bx bx-power-off"></i>
                <div data-i18n="Layouts">Keluar</div>
            </a>
        </li>
    </ul>
</aside>
